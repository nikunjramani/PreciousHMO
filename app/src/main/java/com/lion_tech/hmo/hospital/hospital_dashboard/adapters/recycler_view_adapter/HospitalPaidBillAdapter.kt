...
class HospitalPaidBillAdapter(var context: Context,var hospitalPaidBillsFrag:HospitalPaidBill) :
    RecyclerView.Adapter<HospitalPaidBillAdapter.BillViewModel>() {
...
//            AppLevelData.hospitalRequestFrag!!.showDepDetail(requestList[position], outputFormat.format(date))
           hospitalPaidBillsFrag.sendRequestForDrugsAndService(billList[position], outputFormat.format(date))
